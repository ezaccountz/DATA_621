...
## * **2. Backward Elimination with Chi-square test:**
...
## * **3. Backward Elimination based on the t-values of the coefficients:**
...
model_compare$Accurarcy_average <- apply(model_compare[,c(2:6)],1,mean)
...
Since model_chi_0.1 is a simpler model with 15 coefficients, we select 
model_chi_0.1 as our best model
...
We conclude that our model does not have notable violation against its validity. 
